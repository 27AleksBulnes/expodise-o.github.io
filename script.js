...
let banderas = ["pa.svg", "bo.svg", "ad.svg", "gb.svg", "na.svg", "is.svg","gre.svg"];

//arreglo que guardara la opcion correcta
let correcta = [2,2,1,1,0,1,0];

//arreglo que guardara los paises a mostrar en cada jugada
let opciones = [];
//cargo en el arreglo opciones las opciones a mostrar en cada jugada
opciones.push(["SUDAFRICA", "SINGAPUR", "PANAMA"]);
opciones.push(["PERU", "ECUADOR", "BOLIVIA"]);
...
opciones.push(["LIBANO", "ISRAEL", "JORDANIA"]);
opciones.push(["GRECIA", "ESLOVENIA", "SERBIA"]);
